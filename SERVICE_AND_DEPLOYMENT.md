...
- 월, 수, 금 운동 일정 표시
- 운동 순서: 가슴, 등, 어깨, 복근, 하체
- 초보자용 6종 루틴: 인클라인 푸쉬업, 벤트오버 로우, 사이드 레터럴 레이즈, AB슬라이드 무릎 롤아웃, 맨몸 스쿼트, 글루트 브릿지
...
- 초보자 기준으로 하루 루틴을 6개 운동으로 개편
- 모든 운동은 3세트를 목표로 하되, 1-2세트만 성공해도 오늘 운동 완료 가능
- 집에 있는 AB슬라이드를 활용하도록 `AB슬라이드 무릎 롤아웃` 추가
- 하체 후면 보완을 위해 `글루트 브릿지` 추가
- `assets/ab-wheel-rollout.svg`, `assets/glute-bridge.svg` 직접 제작 이미지 추가
...
| --- | --- | --- | --- | --- |
| 1 | 인클라인 푸쉬업 | 6-12회 | 3세트 | 튼튼한 책상, 의자, 벤치 |
| 2 | 벤트오버 로우 | 10-15회 | 3세트 | 물병, 백팩, 덤벨 |
| 3 | 사이드 레터럴 레이즈 | 12-20회 | 3세트 | 작은 물병, 가벼운 덤벨 |
| 4 | AB슬라이드 무릎 롤아웃 | 3-8회 | 3세트 | AB슬라이드, 무릎 매트 |
| 5 | 맨몸 스쿼트 | 8-15회 | 3세트 | 맨몸 |
| 6 | 글루트 브릿지 | 10-15회 | 3세트 | 매트 |
